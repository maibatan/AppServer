    ...
    public class InventoriesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Inventory>>> Get()
        {
            return  await _context.Inventories
                  .Include(inventory=> inventory.PhysicalDetails).ThenInclude(detail=> detail.InstanceNavigation).ThenInclude(instance => instance.AssetItemNavigation)
                  .Include(inventory => inventory.ExpectedDetails).ThenInclude(detail => detail.AssetItemNavigation)
                  .ToListAsync();
        }
